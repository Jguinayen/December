...
<asp:Content ID="Content2" ContentPlaceHolderID="rightcolumn" Runat="Server">
 ...
 <%-- REPORTS MENU --%>
        ...
        <br /><br />
<<<<<<< HEAD
        <asp:GridView ID="GridViewAllBooks" runat="server" CellPadding="4" ForeColor="#333333" GridLines="Both" Width="100%" BorderWidth="2" CellSpacing="2" BorderColor="#ffffff">
...
=======
        <asp:GridView ID="GridViewAllBooks" runat="server" CellPadding="4" ForeColor="#333333" GridLines="Both" Width="100%" BorderColor="White" BorderWidth="2px">
