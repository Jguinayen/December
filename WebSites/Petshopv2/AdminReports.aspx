...
<asp:Content ID="Content2" ContentPlaceHolderID="rightcolumn" Runat="Server">
     ...
     <p id="pagetitle">Reports - Upcoming Bookings (Today)</p>
...
<<<<<<< HEAD
        <asp:GridView ID="GridViewUpcoming" runat="server" CellPadding="4" ForeColor="#333333" GridLines="Both" Width="100%" BorderWidth="2" CellSpacing="2" BorderColor="#ffffff">
...
=======
        <asp:GridView ID="GridViewUpcoming" runat="server" CellPadding="6" ForeColor="#333333" GridLines="Both" Width="100%" BorderWidth="2" CellSpacing="2" BorderColor="#ffffff">
            <AlternatingRowStyle BackColor="White" />
            <FooterStyle BackColor="#990000" Font-Bold="True" ForeColor="White" />
