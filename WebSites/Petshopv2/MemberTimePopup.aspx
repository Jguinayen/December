...
<body>
    ...
    <div>
        ...
        <asp:Button ID="btnAdminTimePopup09am" runat="server" Text="09:00 AM" OnClick="btnAdminTimePopup09am_Click" CssClass="btn btn-success" style="width:100%; margin: 2px 0px 2px 0px;" /><br />
